...
const { exportDashboardToExcel } = require('../controllers/home');


router.get('/export-dashboard', exportDashboardToExcel);
...
router.get('/technicienEngineer',homeController.clinicalEngineer)
...
router.get('/dashbord',homeController.dashbord)
