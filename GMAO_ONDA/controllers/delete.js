...
exports.deleteAgentSupplier=(req,res)=>{
 ...
 exports.deleteClinicalEngineer=(req,res)=>{
    ...
    ClinicalEngineer.findByPk(dssn).then(clinicalEngineer =>{ 
     clinicalEngineer.destroy().then( res.redirect('/technicienEngineer'))
 ...
 exports.deleteDepartment=(req,res)=>{
   code=req.params.id
   Department.findByPk(code).then(department =>{ 
    department.destroy().then(res.redirect('/department'))
