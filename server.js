...
Dashboard.belongsTo(department);
Dashboard.belongsTo(work_order);
Dashboard.belongsTo(break_down);
Dashboard.belongsTo(maintenance);

department.hasMany(Dashboard);
work_order.hasMany(Dashboard);
break_down.hasMany(Dashboard);
maintenance.hasMany(Dashboard);

// Department.js
department.hasMany(Dashboard, { foreignKey: 'DepartmentCode', as: 'Dashboard' });
